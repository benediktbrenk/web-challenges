...
productTeaser.classList = "product";
productTeaser.innerHTML = `<div class="product__body">
...
<button type="button" class="product__buy-button" data-js="product__buy-button2">Buy</button>
</footer>`;

document.body.append(productTeaser);

const button = document.querySelector(`[data-js="product__buy-button2"]`);

button.addEventListener("click", () => {
  console.log(nameFish);
  console.log(price);
});
